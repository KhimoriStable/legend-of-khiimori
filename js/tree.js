const LINE_SETTINGS = [
    { key: "A", title: "Линия A", subtitle: "Линия Хавара и Амении", note: "Завершённая основательская линия; развитие продолжается через потомков второго поколения" },
    { key: "B", title: "Линия B", subtitle: "Линия Гола и Шоно", note: "Снежно-горная линия с упором на устойчивость, выносливость и зимние признаки" },
    { key: "C", title: "Линия C", subtitle: "Линия Их-Мори и Нандын", note: "Универсальная линия с сочетанием силы, скорости и координации" },
    { key: "D", title: "Линия D", subtitle: "Резервная линия", note: "Будущая дополнительная основательская пара" },
    { key: "E", title: "Линия E", subtitle: "Резервная линия", note: "Будущая дополнительная основательская пара" },
    { key: "F", title: "Линия F", subtitle: "Резервная линия", note: "Будущая дополнительная основательская пара" }
];
